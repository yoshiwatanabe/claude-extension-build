---
name: file-stats
description: Analyzes files and provides detailed statistics including line counts, file size, detected language, and complexity. Use when the user wants to analyze a file or get file statistics.
---
